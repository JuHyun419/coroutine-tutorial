...
fun main() = runBlocking<Unit> {
    ...
    println("[${getElapsedTime2(startTime)}] 참여자 목록: ${listOf(*participants1, *participants2)}")
}

private fun getElapsedTime2(startTime: Long): String = "지난 시간: ${System.currentTimeMillis() - startTime}ms"
